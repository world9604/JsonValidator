...
public class EmBatteryMonitorEntity {
    ...
    //default 값으로 설정
    public EmBatteryMonitorEntity(int thresholdShowAtHour, boolean warningNotification,
                                  int warningThreshold, boolean eolNotification,
                                  int eolThreshold, boolean overheatNotification,
