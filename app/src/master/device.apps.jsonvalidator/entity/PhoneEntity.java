...
public class PhoneEntity {
    ...
    // begin added by noah.ahn; Dec. 1, 2022;
    @Expose
    @SerializedName("apn_clear")
    private String apn_clear;
    // end added by noah.ahn; Dec. 1, 2022;
    ...
    // begin added by noah.ahn; Dec. 1, 2022;
    public String getApn_clear() { return apn_clear; }
    public void setApn_clear(String apn_clear) {this.apn_clear = apn_clear; }
    // end added by noah.ahn; Dec. 1, 2022;
}
