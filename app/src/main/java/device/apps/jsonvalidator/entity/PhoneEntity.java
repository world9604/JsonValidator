...
public class PhoneEntity {
    @Valid
    @Expose
    @SerializedName("listPhoneConfig")
    private ArrayList<PhoneValueEntity> listPhoneConfig;

    @PodamStringValue
    @Pattern(regexp = "^(true|false)$", message = "allowed_key_list_msg::true|false")
    @Expose
    @SerializedName("reset_to_default")
    private String reset_to_default;

    @PodamCollection(nbrElements = 3)
    @Expose
    @SerializedName("remove_dedicated_entries")
    private ArrayList<String> remove_dedicated_entries;

    @PodamStringValue
    @Pattern(regexp = "^(Keep Current Option|Enable|Disable)$", message = "allowed_key_list_msg::Keep Current Option|Enable|Disable")
    @Expose
    @SerializedName("dataRoaming_Sim1")
    private String dataRoaming_Sim1;

    @PodamStringValue
    @Pattern(regexp = "^(Keep Current Option|Enable|Disable)$", message = "allowed_key_list_msg::Keep Current Option|Enable|Disable")
    @SerializedName("dataRoaming_Sim2")
    private String dataRoaming_Sim2;
    ...
    public ArrayList<PhoneValueEntity> getListPhoneConfig()
    {
        return listPhoneConfig;
    }

    public void setListPhoneConfig(ArrayList<PhoneValueEntity> listPhoneConfig)
    {
        this.listPhoneConfig = listPhoneConfig;
    }

    public String getReset_to_default()
    {
        return reset_to_default;
    }

    public void setReset_to_default(String reset_to_default)
    {
        this.reset_to_default = reset_to_default;
    }

    public ArrayList<String> getRemove_dedicated_entries()
    {
        return remove_dedicated_entries;
    }

    public void setRemove_dedicated_entries(ArrayList<String> remove_dedicated_entries)
    {
        this.remove_dedicated_entries = remove_dedicated_entries;
    }

    public String getDataRoaming_Sim1()
    {
        return dataRoaming_Sim1;
    }

    public void setDataRoaming_Sim1(String dataRoaming_Sim1)
    {
        this.dataRoaming_Sim1 = dataRoaming_Sim1;
    }

    public String getDataRoaming_Sim2()
    {
        return dataRoaming_Sim2;
    }

    public void setDataRoaming_Sim2(String dataRoaming_Sim2)
    {
        this.dataRoaming_Sim2 = dataRoaming_Sim2;
    }
