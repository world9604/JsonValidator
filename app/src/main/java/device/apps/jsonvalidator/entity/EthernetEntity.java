...
public class EthernetEntity {
    @PodamStringValue
    @Pattern(regexp = "^(Keep Current Option|DHCP|Static)$", message = "allowed_key_list_msg::Keep Current Option|DHCP|Static")
    @Expose
    ...
    @PodamStringValue
    @Pattern(regexp = "^(None|Manual|Proxy Auto-Config)$", message = "allowed_key_list_msg::None|Manual|Proxy Auto-Config")
    @Expose
